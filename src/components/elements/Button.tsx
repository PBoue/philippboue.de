...
const buttonVariants = cva(
	"inline-flex max-w-fit items-center justify-center rounded-md text-md font-medium font-body transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
				default: "bg-cyan text-black shadow hover:bg-cyan/90",
				secondary:
